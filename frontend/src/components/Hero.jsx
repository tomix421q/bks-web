    ...
    <>
      ...
      <div className='hero-img  flex justify-center h-screen bg-fixed bg-center bg-cover '>
        <div className=' max-w-[1250px] lg:h-[900px] flex flex-col  lg:top-36 lg:flex-row z-30 '>
          <Smallbanner />
          {/* case without banner */}
          <div className=' max-w-[1250px] lg:h-[700px] p-2 flex flex-col md:p-6 lg:flex-row lg:mt-14'>
            {/* BKS H1 */}
            <div className='absolute z-30 top-0 bg-gray-800/60 flex flex-col  ml-6 max-w-[160px] p-2 font-oswald md:max-w-[250px] lg:max-w-[650px] lg:relative lg:bg-transparent'>
              <h1 className='font-oswald text-6xl text-gray-200  rounded-md  md:text-9xl lg:text-[22rem] plus:text-[6.25rem]'>
                BKS<span className='text-color-green'>.</span>
              </h1>
              {/* Kvalita */}
              <h2
                className='
               text-sm text-gray-300 p-2 uppercase plus:text-2xl md:text-4xl  lg:text-3xl lg:ml-4'
              >
