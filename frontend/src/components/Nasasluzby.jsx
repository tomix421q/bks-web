  ...
  return (
    <div className=' font-oswald text-gray-700 mx-auto p-2  lg:mt-28 flex flex-col lg:flex-row '>
      ...
      <div className='mx-auto'>
        ...
        <ul className=' text-gray-200  text-lg text-left  grid grid-cols-1    font-robotoLight font-normal  md:text-2xl md:mt-4 lg:text-2xl   plus:text-2xl max-w-[600px]'>
          <li className='  bg-black   p-2 m-2 backdrop-blur-sm w-[200px] h-[200px] text-2xl'>
            Veľkoformátové obkladanie do rozmeru 160x320cm
          </li>
          <li className=' bg-black/20 border-l-4 border-color-green p-2 m-2 backdrop-blur-sm'>
            {' '}
          ...
          <li className=' bg-black/20 border-l-4 border-color-green p-2 m-1 backdrop-blur-sm'>
            {' '}
            Realizacia krbov
          </li>
        </ul>
      ...
      <div className=' text-white mx-auto mt-24 lg:mt-0'>
        ...
        <ul className='text-gray-200 text-lg text-left  grid grid-cols-1    font-robotoLight font-normal  md:text-2xl md:mt-4 lg:text-2xl   plus:text-2xl max-w-[600px]'>
          <li className='bg-black/20 border-l-4 border-color-darkseablue p-2 m-2 backdrop-blur-sm'>
