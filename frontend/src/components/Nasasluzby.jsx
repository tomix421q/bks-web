const Nasasluzby = () => {
  return (
    <div
      id='ourServices'
      className=' font-oswald text-gray-700 mx-auto  lg:mt-28 flex flex-col  '
    >
      {/* LEFT  */}
      <div className='mx-auto lg:mt-[50px]'>
        <div className='text-center w-fit mx-auto lg:mb-[100px] mb-10 grid'>
          <h1 className='text-3xl lg:text-6xl  mx-auto text-white p-4 m-2  bg-gray-700/10 transition-all duration-300 ease-in-out hover:scale-105 backdrop-blur-sm font-robotoLight font-thin border-2 mt-20'>
